...
public class UserRepository implements IUserRepo {
    ...
    private UserRepository() {
        ...
        clients.add(new User(1, "Ivan", "1111".hashCode(), 0000000000000001));
        clients.add(new User(2, "Vasiliy", "2222".hashCode(),0000000000000001 ));
        clients.add(new User(3, "Fedor", "3333".hashCode(), 0000000000000001));
        clients.add(new User(4, "Grigoriy", "4444".hashCode(), 0000000000000001));
    }
